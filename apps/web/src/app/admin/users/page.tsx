        ...
        <div className="space-y-6">
            ...
            {!isLoading && users.length > 0 && (
                <div className="flex gap-3 flex-wrap">
                    <span className="px-3 py-1.5 rounded-full text-xs font-medium bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400">
                        {roleCounts.STUDENT} Students
                    </span>
                    <span className="px-3 py-1.5 rounded-full text-xs font-medium bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400">
                        {roleCounts.TEACHER} Teachers
                    </span>
                    <span className="px-3 py-1.5 rounded-full text-xs font-medium bg-violet-100 text-violet-700 dark:bg-violet-900/30 dark:text-violet-400">
